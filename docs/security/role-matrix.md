...
เครื่องหมายในตารางคือ policy เป้าหมายของ Phase 1 ปัจจุบันระบบบังคับสิทธิ์ผู้ใช้, Catalog และรับสินค้าเข้าสี่แถวแรกแล้ว แต่ละ feature branch ต้องเพิ่ม security tests ของแถวที่เกี่ยวข้องก่อนถือว่าเสร็จ
